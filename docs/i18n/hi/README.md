...
एक एम्बर रंग की यात्री बिल्ली, जो खोज टोपी पहने, स्टिकर लगा सूटकेस खींचती और कागज़ के हवाई जहाज़ का पीछा करती है — **e-cat (एक बिल्ली)** फ्रेमवर्क से «जन्मी»। बिल्ली के चेहरे की डिज़ाइन [Twemoji](https://github.com/jdecked/twemoji) 1f431 (CC-BY 4.0) पर आधारित है, जिसे संशोधित किया गया; खोज टोपी / सूटकेस / कागज़ का हवाई जहाज़ मौलिक हैं। वेक्टर स्रोत और पूरी जानकारी देखें [`docs/mascot.svg`](docs/mascot.svg)।

| स्थान | रूप |
| :--- | :--- |
| `docs/mascot.svg` | **एकमात्र वेक्टर स्रोत** (पूर्ण आकृति 512×512) |
| `apps/*/web/favicon.svg` | ब्राउज़र टैब आइकन (चेहरे का क्लोज़-अप संस्करण, 16px पर भी पहचानने योग्य; पुराने ब्राउज़रों के लिए `favicon.png` 16px विकल्प) |
...
| `apps/client/harmonyos/.../media/mascot.svg` | HarmonyOS ऐप के भीतर (`Image` से मूल SVG रेंडरिंग; मोबाइल के लिए सरलीकृत संस्करण) |
| सभी README / crate दस्तावेज़ | पृष्ठ शीर्ष पर ब्रांड स्थान |

> डिज़ाइन बदलने के लिए केवल `docs/mascot.svg` बदलें, बाकी सब व्युत्पन्न हैं: favicon उसका चेहरे का क्लोज़-अप क्रॉप है, और HarmonyOS संस्करण `<defs>`/ग्रेडिएंट हटाकर ठोस रंग का उपयोग करता है ताकि मोबाइल SVG रेंडरर में फिट हो सके।
...
│   ├── mascot.svg         # शुभंकर «小途» (एकमात्र वेक्टर स्रोत, favicon व अन्य आइकन इससे व्युत्पन्न)
