...
<p align="center"><img src="../../mascot.svg" alt="Nannan 南南 — Open Travel মাসকট" width="180"></p>
...
একটি কম্পাস পরি: গোল ডায়ালটিই তার শরীর, বেজেলে **12টি দাগ = 12+ ভাষা**, মাথার উপরে সোজা একটি কাঁটা, ডান হাতে আতশকাচ তুলে গন্তব্য খোঁজে, আর বাঁ-উপরের কোণে একটি কাগজের বিমান উড়ানপথ টেনে নিয়ে যায়। সমতল জ্যামিতিক গড়ন (নিরেট রঙের ব্লক + সরু রেখা, গ্রেডিয়েন্ট বা অর্ধস্বচ্ছতা ছাড়াই), ভেক্টর সোর্স ও সম্পূর্ণ বিবরণ দেখুন [`docs/mascot.svg`](../../mascot.svg)।

| অবস্থান | রূপ |
| :--- | :--- |
| `docs/mascot.svg` | **একমাত্র ভেক্টর সোর্স** (পূর্ণ অবয়ব 512×512) |
| `apps/*/web/favicon.svg` | ব্রাউজার ট্যাব আইকন (ডায়ালের ক্লোজ-আপ সংস্করণ, 16px-এও চেনা যায়; পুরনো ব্রাউজারের জন্য `favicon.png` 16px বিকল্প) |
...
| `apps/client/harmonyos/.../media/mascot.svg` | HarmonyOS অ্যাপের ভেতরে (`Image` দিয়ে নেটিভ SVG রেন্ডারিং; মোবাইলের জন্য `opacity`-মুক্ত সংস্করণ) |
| সব README / crate ডকুমেন্টেশন | পৃষ্ঠার শীর্ষে ব্র্যান্ড স্থান |

> চেহারা বদলাতে শুধু `docs/mascot.svg` বদলান, বাকি সবই উদ্ভূত: favicon হলো তার ডায়ালের ক্লোজ-আপ ক্রপ (হাত / আতশকাচ / পা / উড়ানপথ—যে রেখাগুলো ছোট আকারে ঝাপসা হয়ে যায় সেগুলো বাদ দিয়ে), আর HarmonyOS সংস্করণ অর্ধস্বচ্ছ রঙ আগেই নিরেট রঙে পরিণত করে সব `opacity` বাদ দেয়, যাতে মোবাইল SVG রেন্ডারারে মানিয়ে যায়। সব ছবি মৌলিক, তৃতীয় পক্ষের কোনো উপাদানের উপর নির্ভরতা নেই।
...
│   ├── mascot.svg         # মাসকট «南南» (একমাত্র ভেক্টর সোর্স, favicon ও অন্যান্য আইকন এটি থেকে উদ্ভূত)
